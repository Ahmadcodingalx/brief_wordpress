...
function electronic_supermarket_setup() {
	...
	load_theme_textdomain( 'electronic-supermarket', get_template_directory() . '/language' );
...
function electronic_supermarket_scripts() {
	...
	wp_add_inline_style( 'electronic-supermarket-style',$electronic_supermarket_tp_theme_css );
	wp_style_add_data('electronic-supermarket-style', 'rtl', 'replace');
...
define('ELECTRONIC_SUPERMARKET_CREDIT',__('https://www.themespride.com/products/free-electronic-wordpress-theme','electronic-supermarket') );
