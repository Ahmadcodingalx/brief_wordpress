...
function electronic_supermarket_customize_register( $wp_customize ) {
	...
	$electronic_supermarket_font_array = array(
		''                       => 'No Fonts',
	...
	$wp_customize->add_section('electronic_supermarket_typography_option',array(
		'title'         => __('TP Typography Option', 'electronic-supermarket'),
		'priority' => 1,
		'panel' => 'electronic_supermarket_panel_id'
   	));

   	$wp_customize->add_setting('electronic_supermarket_heading_font_family', array(
		'default'           => '',
		'capability'        => 'edit_theme_options',
		'sanitize_callback' => 'electronic_supermarket_sanitize_choices',
	));
	$wp_customize->add_control(	'electronic_supermarket_heading_font_family', array(
		'section' => 'electronic_supermarket_typography_option',
		'label'   => __('heading Fonts', 'electronic-supermarket'),
		'type'    => 'select',
		'choices' => $electronic_supermarket_font_array,
	));

	$wp_customize->add_setting('electronic_supermarket_body_font_family', array(
		'default'           => '',
		'capability'        => 'edit_theme_options',
		'sanitize_callback' => 'electronic_supermarket_sanitize_choices',
	));
	$wp_customize->add_control(	'electronic_supermarket_body_font_family', array(
		'section' => 'electronic_supermarket_typography_option',
		'label'   => __('Body Fonts', 'electronic-supermarket'),
		'type'    => 'select',
		'choices' => $electronic_supermarket_font_array,
	));
    ...
    $wp_customize->add_control(new Electronic_Supermarket_Control_Sortable($wp_customize, 'blog_meta_order', array(
        ...
        'choices' => array(
            ...
            'category' => __('category', 'electronic-supermarket') ,
        ) ,
    )));
	...
	$wp_customize->add_setting( 'electronic_supermarket_remove_category', array(
		'default'           => true,
		'transport'         => 'refresh',
		'sanitize_callback' => 'electronic_supermarket_sanitize_checkbox',
	) );
	$wp_customize->add_control( new Electronic_Supermarket_Toggle_Control( $wp_customize, 'electronic_supermarket_remove_category', array(
		'label'       => esc_html__( 'Show / Hide Category Option', 'electronic-supermarket' ),
		'section'     => 'electronic_supermarket_blog_option',
		'type'        => 'toggle',
		'settings'    => 'electronic_supermarket_remove_category',
	) ) );
    $wp_customize->selective_refresh->add_partial( 'electronic_supermarket_remove_category', array(
		'selector' => '.box-content a[rel="category"]',
		'render_callback' => 'electronic_supermarket_customize_partial_electronic_supermarket_remove_category',
	));
	$wp_customize->add_setting( 'electronic_supermarket_remove_comment', array(
	 'default'           => true,
	 'transport'         => 'refresh',
	 'sanitize_callback' => 'electronic_supermarket_sanitize_checkbox',
 	) );

	$wp_customize->add_control( new Electronic_Supermarket_Toggle_Control( $wp_customize, 'electronic_supermarket_remove_comment', array(
	 'label'       => esc_html__( 'Show / Hide Comment Form', 'electronic-supermarket' ),
	 'section'     => 'electronic_supermarket_blog_option',
	 'type'        => 'toggle',
	 'settings'    => 'electronic_supermarket_remove_comment',
	) ) );

	$wp_customize->add_setting( 'electronic_supermarket_remove_related_post', array(
	 'default'           => true,
	 'transport'         => 'refresh',
	 'sanitize_callback' => 'electronic_supermarket_sanitize_checkbox',
 	) );

	$wp_customize->add_control( new Electronic_Supermarket_Toggle_Control( $wp_customize, 'electronic_supermarket_remove_related_post', array(
	 'label'       => esc_html__( 'Show / Hide Related Post', 'electronic-supermarket' ),
	 'section'     => 'electronic_supermarket_blog_option',
	 'type'        => 'toggle',
	 'settings'    => 'electronic_supermarket_remove_related_post',
	) ) );
	$wp_customize->add_setting('electronic_supermarket_related_post_heading',array(
		'default'=> __('Related Posts','electronic-supermarket'),
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('electronic_supermarket_related_post_heading',array(
		'label'	=> __('Edit Section Title','electronic-supermarket'),
		'section'=> 'electronic_supermarket_blog_option',
		'type'=> 'text'
	));
	$wp_customize->add_setting( 'electronic_supermarket_related_post_per_page', array(
		'default'              => 3,
		'type'                 => 'theme_mod',
		'transport' 		   => 'refresh',
		'sanitize_callback'    => 'electronic_supermarket_sanitize_number_range',
	...
	$wp_customize->add_control( 'electronic_supermarket_related_post_per_page', array(
		'label'       => esc_html__( 'Related Post Per Page','electronic-supermarket' ),
		'section'     => 'electronic_supermarket_blog_option',
		'type'        => 'number',
		'input_attrs' => array(
			'step'             => 1,
	...
	$wp_customize->add_setting( 'electronic_supermarket_related_post_per_columns', array(
		'default'              => 3,
		'type'                 => 'theme_mod',
		'transport' 		   => 'refresh',
		'sanitize_callback'    => 'electronic_supermarket_sanitize_number_range',
	...
	$wp_customize->add_control( 'electronic_supermarket_related_post_per_columns', array(
		'label'       => esc_html__( 'Related Post Per Row','electronic-supermarket' ),
		'section'     => 'electronic_supermarket_blog_option',
		'type'        => 'number',
		'input_attrs' => array(
			'step'             => 1,
	...
	$wp_customize->add_setting('electronic_supermarket_post_layout',array(
        'default' => 'image-content',
        'sanitize_callback' => 'electronic_supermarket_sanitize_choices'
	));
	$wp_customize->add_control('electronic_supermarket_post_layout',array(
        'type' => 'radio',
        'label'     => __('Post Layout', 'electronic-supermarket'),
        'section' => 'electronic_supermarket_blog_option',
        'choices' => array(
            'image-content' => __('Media-Content','electronic-supermarket'),
            'content-image' => __('Content-Media','electronic-supermarket'),
        ),
	) );
	...
	$wp_customize->add_setting('electronic_supermarket_slider_text',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('electronic_supermarket_slider_text',array(
		'label'	=> __('Add Slider Sale Text','electronic-supermarket'),
		'section'=> 'electronic_supermarket_slider_section',
		'type'=> 'text'
	));
	...
	$wp_customize->add_setting('electronic_supermarket_discount_sale_img1',array(
		'default'	=> '',
		'sanitize_callback'	=> 'esc_url_raw',
	));
	$wp_customize->add_control( new WP_Customize_Image_Control($wp_customize,'electronic_supermarket_discount_sale_img1',array(
	    'label' => __('Select Top Product Image 1','electronic-supermarket'),
	     'section' => 'electronic_supermarket_slider_section'
	)));

	$wp_customize->add_setting('electronic_supermarket_topproduct_title1',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('electronic_supermarket_topproduct_title1',array(
		'label'	=> __('Add Top Products Text 1','electronic-supermarket'),
		'section'=> 'electronic_supermarket_slider_section',
		'type'=> 'text'
	));

	$wp_customize->add_setting('electronic_supermarket_product_sale_discount_title1',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('electronic_supermarket_product_sale_discount_title1',array(
		'label'	=> __('Add Products Title 1','electronic-supermarket'),
		'section'=> 'electronic_supermarket_slider_section',
		'type'=> 'text'
	));

	$wp_customize->add_setting('electronic_supermarket_topproduct_content',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('electronic_supermarket_topproduct_content',array(
		'label'	=> __('Add Products Content 1','electronic-supermarket'),
		'section'=> 'electronic_supermarket_slider_section',
		'type'=> 'text'
	));

	$wp_customize->add_setting('electronic_supermarket_product_btn_text1',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('electronic_supermarket_product_btn_text1',array(
		'label'	=> esc_html__('Add Product Button Text 1','electronic-supermarket'),
		'section'=> 'electronic_supermarket_slider_section',
		'type'=> 'text'
	));

	$wp_customize->add_setting('electronic_supermarket_product_btn_link1',array(
		'default'=> '',
		'sanitize_callback'	=> 'esc_url_raw'
	));
	$wp_customize->add_control('electronic_supermarket_product_btn_link1',array(
		'label'	=> esc_html__('Add Product Button link 1','electronic-supermarket'),
		'section'=> 'electronic_supermarket_slider_section',
		'type'=> 'url'
	));

	$wp_customize->add_setting('electronic_supermarket_discount_sale_img2',array(
		'default'	=> '',
		'sanitize_callback'	=> 'esc_url_raw',
	));
	$wp_customize->add_control( new WP_Customize_Image_Control($wp_customize,'electronic_supermarket_discount_sale_img2',array(
	    'label' => __('Select Top Product Image 2','electronic-supermarket'),
	     'section' => 'electronic_supermarket_slider_section'
	)));

	$wp_customize->add_setting('electronic_supermarket_topproduct_title2',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('electronic_supermarket_topproduct_title2',array(
		'label'	=> __('Add Top Products Text 2','electronic-supermarket'),
		'section'=> 'electronic_supermarket_slider_section',
		'type'=> 'text'
	));

	$wp_customize->add_setting('electronic_supermarket_product_sale_discount_title2',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('electronic_supermarket_product_sale_discount_title2',array(
		'label'	=> __('Add Products Title 2','electronic-supermarket'),
		'section'=> 'electronic_supermarket_slider_section',
		'type'=> 'text'
	));

	$wp_customize->add_setting('electronic_supermarket_product_btn_text2',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('electronic_supermarket_product_btn_text2',array(
		'label'	=> esc_html__('Add Product Button Text 2','electronic-supermarket'),
		'section'=> 'electronic_supermarket_slider_section',
		'type'=> 'text'
	));

	$wp_customize->add_setting('electronic_supermarket_product_btn_link2',array(
		'default'=> '',
		'sanitize_callback'	=> 'esc_url_raw'
	));
	$wp_customize->add_control('electronic_supermarket_product_btn_link2',array(
		'label'	=> esc_html__('Add Product Button link 2','electronic-supermarket'),
		'section'=> 'electronic_supermarket_slider_section',
		'type'=> 'url'
	));
	...
	$wp_customize->add_section('electronic_supermarket_mobile_media_option',array(
		...
		'description' => __('Control will no function if the toggle in the main settings is off.', 'electronic-supermarket'),
		'priority' => 8,
		'panel' => 'electronic_supermarket_panel_id'
	) );
	...
	$wp_customize->add_setting( 'electronic_supermarket_related_post_mob', array(
		'default'           => true,
		'transport'         => 'refresh',
		'sanitize_callback' => 'electronic_supermarket_sanitize_checkbox',
	) );
	$wp_customize->add_control( new Electronic_Supermarket_Toggle_Control( $wp_customize, 'electronic_supermarket_related_post_mob', array(
		'label'       => esc_html__( 'Show / Hide Related Post', 'electronic-supermarket' ),
		'section'     => 'electronic_supermarket_mobile_media_option',
		'type'        => 'toggle',
		'settings'    => 'electronic_supermarket_related_post_mob',
	) ) );
	...
	$wp_customize->add_setting('electronic_supermarket_sale_tag_position',array(
        'default' => 'right',
        'sanitize_callback' => 'electronic_supermarket_sanitize_choices'
	));
	$wp_customize->add_control('electronic_supermarket_sale_tag_position',array(
        'type' => 'radio',
        'label'     => __('Sale Badge Position', 'electronic-supermarket'),
        'description'   => __('This option work for Archieve Products', 'electronic-supermarket'),
        'section' => 'woocommerce_product_catalog',
        'choices' => array(
            'left' => __('Left','electronic-supermarket'),
            'right' => __('Right','electronic-supermarket'),
	...
	// 404 PAGE
	$wp_customize->add_section('electronic_supermarket_404_page_section',array(
		'title'         => __('404 Page', 'electronic-supermarket'),
		'description'   => 'Here you can customize 404 Page content.',
	) );
	$wp_customize->add_setting('electronic_supermarket_not_found_title',array(
		'default'=> __('Oops! That page cant be found.','electronic-supermarket'),
		'sanitize_callback'	=> 'sanitize_text_field',
	));
	$wp_customize->add_control('electronic_supermarket_not_found_title',array(
		'label'	=> __('Edit Title','electronic-supermarket'),
		'section'=> 'electronic_supermarket_404_page_section',
		'type'=> 'text',
	));
	$wp_customize->add_setting('electronic_supermarket_not_found_text',array(
		'default'=> __('It looks like nothing was found at this location. Maybe try a search?','electronic-supermarket'),
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('electronic_supermarket_not_found_text',array(
		'label'	=> __('Edit Text','electronic-supermarket'),
		'section'=> 'electronic_supermarket_404_page_section',
		'type'=> 'text'
	));
...
if ( ! defined( 'ELECTRONIC_SUPERMARKET_PRO_THEME_URL' ) ) {
	define( 'ELECTRONIC_SUPERMARKET_PRO_THEME_URL', esc_url('https://www.themespride.com/products/supermarket-wordpress-theme'));
}
if ( ! defined( 'ELECTRONIC_SUPERMARKET_DOCS_URL' ) ) {
	define( 'ELECTRONIC_SUPERMARKET_DOCS_URL', esc_url('https://page.themespride.com/demo/docs/electronic-supermarket/'));
}
