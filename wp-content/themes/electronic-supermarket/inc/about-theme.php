...
if ( ! defined( 'ELECTRONIC_SUPERMARKET_FREE_THEME_URL' ) ) {
	define( 'ELECTRONIC_SUPERMARKET_FREE_THEME_URL', 'https://www.themespride.com/products/free-electronic-wordpress-theme' );
}
if ( ! defined( 'ELECTRONIC_SUPERMARKET_PRO_THEME_URL' ) ) {
	define( 'ELECTRONIC_SUPERMARKET_PRO_THEME_URL', 'https://www.themespride.com/products/supermarket-wordpress-theme' );
}
if ( ! defined( 'ELECTRONIC_SUPERMARKET_DEMO_THEME_URL' ) ) {
	define( 'ELECTRONIC_SUPERMARKET_DEMO_THEME_URL', 'https://page.themespride.com/electronic-supermarket/' );
}
if ( ! defined( 'ELECTRONIC_SUPERMARKET_DOCS_THEME_URL' ) ) {
    define( 'ELECTRONIC_SUPERMARKET_DOCS_THEME_URL', 'https://page.themespride.com/demo/docs/electronic-supermarket/' );
}
	...
	?>
		<div class="feature-section two-col">
			...
			<div class="col card">
				...
				<button class="button button-primary"><?php esc_html_e( 'GETPro20', 'electronic-supermarket' ); ?></button>
			</div>
		</div>
	<?php
	}
